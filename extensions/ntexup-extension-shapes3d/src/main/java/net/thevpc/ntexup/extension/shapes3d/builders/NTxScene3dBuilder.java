package net.thevpc.ntexup.extension.shapes3d.builders;
...
import net.thevpc.ntexup.extension.shapes3d.NTxCamera3DImpl;
import net.thevpc.ntexup.extension.shapes3d.NtxGraphics3DImpl;
import net.thevpc.ntexup.extension.shapes3d.Shape3DHelper;
                ...
                for (NElement child : o.children()) {
                    if(child.isNamedPair()){
                        ...
                        switch (p.asStringValue().get()) {
                            ...
                            case "position":{
                                position=NTxValue.of(p.value()).asPoint3D().orNull();
                                break;
                            }
                            case "target":{
                                target=NTxValue.of(p.value()).asPoint3D().orNull();
                                break;
                            }
                        }
                    }
