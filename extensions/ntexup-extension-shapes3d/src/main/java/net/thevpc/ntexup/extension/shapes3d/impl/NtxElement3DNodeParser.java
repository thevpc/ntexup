...
public interface NtxElement3DNodeParser extends NComponent {
    List<String> getId3d();
    NtxElement3D createElement3D(NTxNode node, NTxRendererContext rendererContext, NTxBounds2D b, RealToRelativeMapper mapper, NtxElement3DNodeParserFactory parserFactory);
}
