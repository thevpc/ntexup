...
public class NTxPoint3D implements NToElement {
    ...
    public static NTxPoint3D denull(NTxPoint3D other) {
        if(other == null) {
            return NTxPoint3D.ofZero();
        }
        return other;
    }

    public static NTxPoint3D ofZero() {
        return new NTxPoint3D(0.0, 0.0, 0.0);
    }

    public static NTxPoint3D ofHundred() {
        return new NTxPoint3D(100.0, 100.0, 100.0);
    }

    public static NTxPoint3D ofOne() {
        return new NTxPoint3D(1.0, 1.0, 1.0);
    }
    ...
    public double distance(NTxPoint3D other) {
